...
import com.example.IsmailShopApi.IsmailShopApi.model.Tshirt;
import com.example.IsmailShopApi.IsmailShopApi.service.ItemService;
...
public class TshirtController {
    ...
    public List<Tshirt> TshirtRetrieveAlHandler() throws ExecutionException, InterruptedException {
        return  tshirtsService.getAllItems(COLLECTION_NAME, Tshirt.class);
    }
